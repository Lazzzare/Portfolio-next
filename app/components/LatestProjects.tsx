        ...
        <div className="mt-8">
          ...
          <div className="flex flex-col gap-8 md:flex-row justify-between">
            ...
            <div className="relative h-full w-full hover:scale-105 duration-300 max-w-[300px] cursor-pointer group hover:rotate-180">
              ...
              />
              <p
                className={`absolute top-[140px] right-[20px] hover:backdrop-blur-none group-hover:-rotate-180 text-lg cursor-pointer text-red-300 opacity-0 group-hover:opacity-100 group-hover:visible transition-opacity duration-300`}
              >
            ...
            <div className="relative h-full w-full hover:scale-105 duration-300 max-w-[300px] cursor-pointer group hover:rotate-180">
              <Image
                ...
                alt="image"
              />
              <p className="absolute top-[140px] right-[20px] hover:backdrop-blur-none group-hover:-rotate-180 text-lg cursor-pointer text-red-300 opacity-0 group-hover:opacity-100 group-hover:visible transition-opacity duration-300">
          ...
          <div className="mt-8 flex flex-col gap-8 md:flex-row justify-between">
            ...
            <div className="relative h-full w-full hover:scale-105 duration-300 max-w-[300px] cursor-pointer group hover:rotate-180">
              ...
              />
              <p className="absolute top-[140px] right-[20px] hover:backdrop-blur-none group-hover:-rotate-180 text-lg cursor-pointer text-red-300 opacity-0 group-hover:opacity-100 group-hover:visible transition-opacity duration-300">
                The Github-User-API is a simple and user-friendly web
                application that allows users to retrieve detailed information
                about a GitHub user based on their username.
              </p>
              {/* HoverIconsLink */}
              <div className="absolute bottom-[170px] left-[80px] gap-[40px] hover:backdrop-blur-none flex flex-row group-hover:-rotate-180 opacity-0 group-hover:opacity-100 group-hover:visible transition-opacity duration-300">
                <div className="flex flex-col items-center">
            ...
            <div className="relative h-full w-full hover:scale-105 duration-300 max-w-[300px] cursor-pointer group hover:rotate-180">
              <Image
                ...
                alt="image"
              />
              <p className="absolute top-[110px] right-[20px] hover:backdrop-blur-none group-hover:-rotate-180 text-lg cursor-pointer text-red-300 opacity-0 group-hover:opacity-100 group-hover:visible transition-opacity duration-300">
