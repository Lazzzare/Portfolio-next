    ...
    <>
      <div className="w-full flex flex-row justify-between items-center text-black dark:text-white">
        ...
        <div className="flex flex-row-reverse md:flex-row items-center gap-x-4">
          ...
          {mobileMenu ? (
            <div className="absolute left-0 right-0 top-0 w-full h-screen flex flex-col items-center mx-auto justify-center bg-black z-10 text-orange-400 hover:text-orange-500">
