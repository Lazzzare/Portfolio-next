...
const page = () => {
  return (
    <div className="mt-32">
      <h1 className="text-4xl font-bold tracking-wide mx-0 items-start justify-start md:mx-auto md:items-center md:justify-center">
        Contact
      </h1>
      <div className="flex flex-row md:flex-col-reverse md:mx-auto md:items-center md:justify-center gap-10">
        <form
          method="POST"
